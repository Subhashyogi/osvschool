...
const ManageTestimonials = () => {
    ...
    async (page = 1, search = "", includeDeleted = false) => {
      ...
      try {
        const response = await authenticatedFetch(
          `https://osvschool-backend.onrender.comapi/testimonials?page=${page}&limit=10&search=${search}&includeDeleted=${includeDeleted}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingTestimonial
        ? `https://osvschool-backend.onrender.comapi/testimonials/${editingTestimonial.id}`
        : "https://osvschool-backend.onrender.comapi/testimonials";
  ...
  const handleDelete = (id) => {
    performAction(
      `https://osvschool-backend.onrender.comapi/testimonials/${id}`,
      "DELETE",
  ...
  const handleRestore = (id) => {
    performAction(
      `https://osvschool-backend.onrender.comapi/testimonials/${id}/restore`,
      "PUT",
