...
const AcademicsPage = () => {
  ...
  return (
    <div className="bg-brand-light">
      <Helmet>
        <title>
          Academic Programs - OSV School | Science, Mathematics, Arts & Commerce
        </title>
        <meta
          name="description"
          content="Explore our comprehensive academic programs at OSV School. From Science & Technology to Mathematics, Arts & Humanities, and Commerce & Business. Expert faculty and modern facilities."
        />
        <meta
          name="keywords"
          content="academic programs, science programs, mathematics education, arts and humanities, commerce education, school curriculum, academic excellence, expert faculty, modern facilities"
        />
      ...
      {/* Hero Section */}
      <header
        className="pt-32 pb-20 bg-gradient-to-br from-blue-50 to-indigo-100 text-center px-4"
        style={{
          background: `url('/assets/2.png') top center / cover no-repeat`,
      ...
      >
        ...
        >
          Our curriculum develops academic excellence, creativity, and critical
          thinking through four core learning streams, preparing students for
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-brand-muted max-w-3xl mx-auto">
              ...
              receives personalized attention and develops the skills needed for
              future success.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Learn from experienced educators with advanced degrees and industry expertise.",
              },
              {
                icon: FaLaptop,
                title: "Modern Facilities",
                description:
                  "State-of-the-art laboratories and technology-enhanced learning environments.",
              },
              {
                icon: FaUsers,
                title: "Small Class Sizes",
                description:
                  "Personalized attention with optimal student-teacher ratios for better learning.",
              },
              {
                icon: FaTrophy,
                title: "Proven Success",
                description:
                  "Consistent track record of students achieving top ranks in competitive exams.",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Join a legacy of academic excellence where every student discovers
              their potential. Our proven track record of success, expert
              faculty, and comprehensive curriculum prepare you for the
